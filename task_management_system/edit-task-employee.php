...
<?php include "inc/header.php" ?>
	<div class="body">
		...
		<section class="section-1">
			<h4 class="title">Edit Task <a href="my_task.php">Task</a></h4>
    ...
    <?php } ?>
            ...
            <div class="input-holder">
             ...
             <div class="input-holder">
                <label></label>
                 <p><b>Description:</b><?=$task['description']?></p><br><br>    
            </div>
            <div class="input-holder">
                <label>Status</label>
                ...
                <option 
                <?php if($task['status'] == "in_progress") echo "selected"; ?>>in_progress
               </option>

                <option 
                <?php if($task['status'] == "completed") echo "selected"; ?>>completed
                </option>
