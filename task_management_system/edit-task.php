...
<?php include "inc/header.php" ?>
	<div class="body">
		...
		<section class="section-1">
			<h4 class="title">Edit Task <a href="tasks.php">Task</a></h4>
    ...
    <?php } ?>
            ...
            <div class="input-holder">
                <label>Title</label>
                <input type="text" name="title"class="input-1" placeholder="Full Name " value="<?=$task['title']?>"><br><br>
            </div>
            ...
            <div class="input-holder">
                <label>Snooze</label>
                <input type="date" name="due_date"class="input-1" placeholder="Snooze" value="<?=$task['due_date']?>"><br><br>
            </div>
            <div class="input-holder">
