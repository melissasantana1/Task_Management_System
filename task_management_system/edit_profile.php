...
<?php include "inc/header.php" ?>
    ...
    <?php } ?>
            ...
            <div class="input-holder">
                ...
                <input type="text" name="full_name"class="input-1" placeholder="Full Name " value="<?=$user['full_name']?>"><br><br>
            </div>

             <div class="input-holder">
                <label>Old Password</label>
                <input type="text" value="*****" name="password"class="input-1" placeholder="Old Password"><br><br>
            </div>
