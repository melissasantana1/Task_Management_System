...
if (isset($_SESSION['role']) && isset($_SESSION['id']) && $_SESSION['role'] == "admin"){
    ...
    if (isset($_GET['due_date']) && $_GET['due_date'] == "Due Today"){
        ...
        $num_task = !empty($tasks) ? count($tasks) : 0;
	...
	<div class="body">
		...
		<section class="section-1">
			<h4 class="title-2">
                ...
                <a href="tasks.php?due_date=Due Today" class="btn">Due Today</a>
                <a href="tasks.php?due_date=Overdue" class="btn">Overdue</a>
                <a href="tasks.php?due_date=No Deadline" class="btn">No Deadline</a>
                <a href="tasks.php" class="btn">All Tasks</a>
